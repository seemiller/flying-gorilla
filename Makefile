...
package: build
	tar zcvf pkg/${BINARY_NAME}-darwin-amd64-$${VERSION}.tar.gz bin/${BINARY_NAME}-darwin-amd64
	tar zcvf pkg/${BINARY_NAME}-linux-amd64-$${VERSION}.tar.gz bin/${BINARY_NAME}-linux-amd64
